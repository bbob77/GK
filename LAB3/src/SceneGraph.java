...
public class SceneGraph extends JPanel {
    ...
    private void createWorld() {
        ...
        w2_1.setScale(1*offsetScale, 1*offsetScale).setColor(Color.blue);
        w2_1.setTranslation(-2.7*offsetScale + offsetX, -0.15*offsetScale + offsetY);

        w2_2 = new TransformedObject(filledPolygon);
        w2_2.setScale(1*offsetScale, 1*offsetScale).setColor(Color.blue);
        ...
        w3_1.setScale(1.7*offsetScale, 1.7*offsetScale).setColor(Color.blue);
        w3_1.setTranslation(-3.9*offsetScale + offsetX, -1.5*offsetScale + offsetY);

        w3_2 = new TransformedObject(filledPolygon);
        w3_2.setScale(1.7*offsetScale, 1.7*offsetScale).setColor(Color.blue);
